...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  spicy_foods.filter do |food_hash|
     food_hash[:cuisine] == cuisine.capitalize()
  end
end
...
def sort_by_heat(spicy_foods)
  spicy_foods.sort_by do |food_hash|
...
def average_heat_level(spicy_foods)
  # your code here
  spicy_foods.sum do |food_hash|
    food_hash[:heat_level]/3
  end
end
